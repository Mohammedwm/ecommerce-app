                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-price"><span
                                                class="amount">${{$item->model->sale_price}}</span></td>
                                        <td class="product-quantity">
                                            <a class="btn" href="#"
                                                wire:click.prevent="decreaseQuantity('{{$item->rowId}}')"><i
                                                    class="fa fa-minus-circle"></i></a>
                                            <input type="text" value="{{$item->qty}}" min="1" max="100"
                                                pattern="[0-9]*" />
                                            <a class="btn" href="#"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 smt-40 xmt-40">
                                <div class="htc__cart__total">
                                    ...
                                    <div class="cart__desk__list">
                                        <ul class="cart__desc">
                                            <li>cart total</li>
                                            <li>Discount ({{Session::get('coupon')['code']}}) <a href="#"
                                                    wire:click.prevent="removeCoupon"><i
                                                        class="fa fa-times text-danger"></i></a></li>
