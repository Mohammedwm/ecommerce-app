                            ...
                            <div class="accordion">
                                    ...
                                    <div class="bilinfo">
                                        <form action="#">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-input">
                                                        <input type="number" class="col-md-12" name="phone" value=""
                                                ...
                                                <div class="col-md-12">
                                                    <div class="single-input">
                                                        <input type="text" placeholder="Line1" name="add"
                                                            wire:model="line1">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="single-input">
                                                        <input type="text" placeholder="Line2" name="add"
                                                            wire:model="line2">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="single-input">
                                                        <input type="text" name="zip-code" placeholder="Postcode / ZIP"
                                                            wire:model="zipcode">
                                ...
                                <div class="accordion__body">
                                    <div class="shipinfo">
                                        ...
                                        <a href="#" class="ship-to-another-trigger"
                                            wire:click.prevent="Change_ShipToDifferent"><i
                                                class="zmdi zmdi-long-arrow-right"></i>Ship to another address</a>
                                        <div class="ship-to-another-content" @if ($ship_to_different)
                                        ...
                                        <form action="#">
                                            <div class="single-input">
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid
                                                    voluptatum quaerat totam hic suscipit quam repellat debitis ad sed
                                                    aperiam quisquam quibusdam enim labore, ipsa illo, natus ipsam
                                            ...
                                            <div class="single-input">
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam
                                                    maxime, eaque eos! Quidem officia similique, fuga consequatur vero?
                                                    Quis autem dicta voluptatibus veniam temporibus rem reprehenderit
                                                    placeat quaerat sunt ducimus.</p>
                                            </div>
                                        </form>
                                    </div>
                                </div> --}}
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="single-input">
                                                            <input type="password" name="cvc" value="" placeholder="cvc"
                                                                wire:model="cvc">
                                                            @error('cvc') <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                </div>
