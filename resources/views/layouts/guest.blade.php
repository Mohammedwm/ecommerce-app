                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
                                <div class="logo">
                                     <a href="/"><img src="{{ asset('assets/images/logo/4.png') }}" alt="logo images"></a>
                                </div>
                            </div>
                    ...
                    <div class="shp__cart__wrap">
                        <div class="shp__single__product">
                            <div class="shp__pro__thumb">
                                <a href="#">
                                    <img src="{{ asset('assets/images/product-2/sm-smg/1.jpg') }}" alt="product images">
                                </a>
                            </div>
                        ...
                        <div class="shp__single__product">
                            <div class="shp__pro__thumb">
                                <a href="#">
                                    <img src="{{ asset('assets/images/product-2/sm-smg/2.jpg') }}" alt="product images">
                                </a>
                            </div>
                            <div class="shp__pro__details">
