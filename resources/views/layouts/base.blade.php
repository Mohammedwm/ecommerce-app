...
<head>
    ...
    <title>Mushtaha Shopping</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- Place favicon.ico in the root directory -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/favicon1.ico') }}">
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
                                <div class="logo">
                                     <a href="{{ route('home') }}"><img src="{{ asset('assets/images/logo/44.png') }}" alt="logo images"></a>
                                </div>
                            </div>
                                ...
                                <div class="header__right">
                                    ...
                                    <div class="header__account">
                                        @if (Route::has('login'))
                                            ...
                                            <nav class="main__menu__nav hidden-xs hidden-sm">
                                                <ul class="main__menu">
                                                    <li class="drop"><a href="#" style="display : inline"><i class="icon-user icons"></i></a>
                                                        <ul class="dropdown">
                    ...
                    @foreach (Cart::instance('cart')->content() as $item)
                        <div class="shp__single__product">
                            ...
                            <div class="shp__pro__details">
                                ...
                                <span class="shp__price">${{$item->model->sale_price}}</span>
                            </div>
                            <div class="remove__btn">
                                <a href="#" title="Remove this item" wire:click.prevent="destroy('{{$item->rowId}}')"><i class="zmdi zmdi-close"></i></a>
                            </div>
                        </div>
                    @endforeach
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="copyright__inner">
                                <p>Copyright© <a href="#">Free themes Cloud</a> 2018. All right reserved.</p>
                                <a href="#"><img src="{{ asset('assets/images/others/shape/paypol.png') }}" alt="payment images"></a>
                            </div>
                        </div>
                    </div>
                </div>
